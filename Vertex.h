...
Name: Lucy Tran
Date: 11 - 30 - 16
Header File : Vertex & PathWeightComparator
MA6 : Dijkstra's Algorithm

The unordered map, "edges," contains buckets that are indexed
by a pointer to a vertex. In the buckets is the edge.
*/
...
private:
	int _id;
	static int _id_counter; //Number of items in the map
